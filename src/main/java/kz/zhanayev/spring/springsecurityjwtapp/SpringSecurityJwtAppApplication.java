...
public class SpringSecurityJwtAppApplication {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        // Настройка фильтров вручную вместо использования apply()
        ...
        return http
                ...
                .authorizeHttpRequests(authorizeHttpRequests ->
                        authorizeHttpRequests
                                .requestMatchers("/manager.html").hasRole("MANAGER") // Доступ только для роли MANAGER
                                .requestMatchers("/error").permitAll() // Доступ к /error для всех
                                .anyRequest().authenticated()) // Остальные запросы должны быть аутентифицированы
                .build();
    }
