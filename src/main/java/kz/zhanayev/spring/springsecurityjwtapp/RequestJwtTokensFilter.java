...
public class RequestJwtTokensFilter extends OncePerRequestFilter {
    ...
    private DefaultRefreshTokenFactory refreshTokenFactory = new DefaultRefreshTokenFactory();
    ...
    public void setRefreshTokenFactory(DefaultRefreshTokenFactory refreshTokenFactory) {
